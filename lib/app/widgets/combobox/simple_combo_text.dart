...
class SimpleComboText extends StatefulWidget {
  const SimpleComboText({
    Key key,
    @required this.list,
  ...
  @override
  _SimpleComboTextState createState() => _SimpleComboTextState();
}

class _SimpleComboTextState extends State<SimpleComboText> {
